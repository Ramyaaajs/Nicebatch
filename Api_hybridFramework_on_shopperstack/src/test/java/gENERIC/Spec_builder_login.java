...
public ResponseSpecification response(int code,String content)
{
	...
	ResponseSpecification res = res1.expectStatusCode(code).expectContentType(content).build();
    return res;
}
